    ...
    return (
        <nav className="bg-black/80 backdrop-blur-md px-6 py-4 flex justify-between items-center shadow-lg border-b border-gray-800/50 sticky top-0 z-50">
            ...
            <div className="flex gap-1">
                ...
                <Link to='/auth_form' className="px-4 py-2 ml-2 rounded-lg bg-gradient-to-r from-red-600 to-red-500 text-white font-medium transition-all duration-200 hover:shadow-lg hover:shadow-red-500/50">
                    Login
                </Link>
            </div>
        </nav>
